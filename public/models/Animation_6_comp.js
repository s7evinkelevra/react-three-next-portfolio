...
export function Model(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/animation_6_comp.glb')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group>
        ...
        <group name="Camera" position={[0.27, 26.01, 15.6]} rotation={[1.63, 0.01, -0.03]}>
        ...
        <group name="Rocket_Ship_01" position={[24.95, 0.42, -9.62]} rotation={[-1.69, -0.89, -2.4]} scale={0.07}>
...
useGLTF.preload('/animation_6_comp.glb')
