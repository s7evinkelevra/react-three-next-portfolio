...
- Layout of the graph via <a rel="noreferrer" target="_blank" href="https://github.com/vasturiano/react-force-graph">react-force-graph</a> (react bindings for force-graph)
