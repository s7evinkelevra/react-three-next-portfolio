...
- <a rel="noreferrer" target="_blank" href="https://react-query-v3.tanstack.com/">React query</a> for data fetching + caching
- Layout of the graph via <a rel="noreferrer" target="_blank" href="https://github.com/vasturiano/react-force-graph">react-force-graph</a> (react bindings for <a rel="noreferrer" target="_blank" href="https://github.com/vasturiano/force-graph">force-graph</a>)
