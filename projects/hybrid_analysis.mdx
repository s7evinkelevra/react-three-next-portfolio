...
## tl;dr
For my bachelor&apos;s degree, i extract DNA and mitochondrial DNA from two species of mouse lemours (_M. griseorufus_ and _M. murinus_) and check if they <a rel="noreferrer" target="_blank" href="https://en.wikipedia.org/wiki/Hybrid_(biology)">hybridize</a> when they meet at a contact zone. Using microsatellites, i concluded they were, but it was later revealed through RADseq that they probably don&apos;t.

## Analysis
For the analysis, i used a combination of specilized bioinformatic tools and a lot of R for the population genetics analysis and plotting.

## Result
I received a degree with a very nice grade on it! (And some scientific insights, see tl;dr)

## Publication
The re-analysis with RADseq and some of my data were the basis for a manuscript, which is now accepted in Proceedings of the Proceedings of the Royal Society B! 🎉 It even contains one of my original figures.